...
def init_wandb(args, cfg):
    ...
    proj_name = "debug_{}_eval".format(adaptation_task)
    entity_name = "chensj" # Please Put your entity name in WANDB
    ...
    run_name = 'EVAL_ON_' + '-' + \
               train_mode_and_aug + \
               '-' + cfg.MODEL.NAME + '-' + args.cfg_file.split('/')[-1].split('.')[0] + "-" + args.extra_tag
