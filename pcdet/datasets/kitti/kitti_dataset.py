...
class KittiDataset(DatasetTemplate):
    ...
    def __getitem__(self, index, aug=False):
        ...
        # if cfg.SELF_TRAIN.get("EMA_TEACHER", None) and self.training and self.dataset_cfg.get('TARGET', None) and not aug and (cfg.SELF_TRAIN.get("EMA_EPOCH", False) == False):
        #     # input_dict['image_shape'] = img_shape
        #     # return input_dict
        #     data_dict = self.prepare_data_teacher(data_dict=input_dict)
        # else:
