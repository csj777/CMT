...
class PVRCNNHead(RoIHeadTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if cfg.get('SELF_TRAIN', None) and batch_dict.get('rois_mt', None) is None:
            # 分配 GT 前的 ROI
